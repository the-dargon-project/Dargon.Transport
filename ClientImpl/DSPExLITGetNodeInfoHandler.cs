...
{
   public class DSPExLITGetNodeInfoHandler : DSPExLITransactionHandler
   {
      /// <summary>
      ...
      /// </summary>
      public DSPExNodeResponseDescriptor ResponseChildNode { get; private set; }
      ...
      /// </param>
      public DSPExLITGetNodeInfoHandler(uint transactionId, uint nodeId, DSPExNodeRequestFlags requestFlags)
         : base(transactionId)
      {
      ...
      public override void ProcessMessage(IDSPExSession session, DSPExMessage message)
      {
         ...
         {
            ResponseNodeExists = reader.ReadByte() != 0;
